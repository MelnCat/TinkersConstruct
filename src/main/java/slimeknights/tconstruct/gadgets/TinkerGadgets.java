...
public final class TinkerGadgets extends TinkerModule {
  /** Tab for all special tools added by the mod TODO!: Move to creative inventory tabs*/
   ...
   * Blocks
   */
  public static final ItemObject<PunjiBlock> punji = BLOCKS.register("punji", () -> new PunjiBlock(builder(SoundType.GRASS).pushReaction(PushReaction.DESTROY).strength(3.0F).speedFactor(0.4F).noOcclusion()), TOOLTIP_BLOCK_ITEM);
