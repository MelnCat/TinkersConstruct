...
public class GadgetRecipeProvider extends BaseRecipeProvider {
  public GadgetRecipeProvider(PackOutput output) {
    super(output);
  }
  ...
  protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    TinkerGadgets.cake.forEach((foliage, cake) -> {
      if (foliage != FoliageType.ICHOR) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, cake)
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TinkerGadgets.magmaCake)
                       .define('M', bucket)
