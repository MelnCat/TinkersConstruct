...
public class FlexMultilayerArmorModel extends FlexModifiableArmorItem {
  ...
  public FlexMultilayerArmorModel(ArmorMaterial material, ArmorItem.Type type, Properties properties, ToolDefinition toolDefinition) {
    super(material, type, properties, toolDefinition);
