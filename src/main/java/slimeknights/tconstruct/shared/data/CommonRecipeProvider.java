...
public class CommonRecipeProvider extends BaseRecipeProvider implements ICommonRecipeHelper {
  ...
  private void addCommonRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, TinkerMaterials.blazewood.getFence(), 6)
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Blocks.DAYLIGHT_DETECTOR)
